...
import kotlinx.android.synthetic.main.act_album_new.*


class ActAlbumNew : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.act_album_new)
    ...
    private fun initRecyFolder() {
        ...
        adaptFolder = AdapterFolder(this@ActAlbumNew, imagesHelper?.getAllImages() ?: arrayListOf()) { index ->
