...
class AdapterFolder(private var context: Context?, var imagePathList: ArrayList<ModelImages>, var listener: (Int) -> Unit) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
